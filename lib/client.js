window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    const css = [
      ...
      ".wd-reason-menu{position:absolute;left:0;right:0;top:28px;z-index:20;max-height:180px;overflow-y:auto;border:1px solid var(--dsw-alias-border-l1);border-radius:8px;background:var(--dsw-alias-bg-base);box-shadow:0 8px 24px rgba(0,0,0,.16),0 0 20px rgba(57,100,254,.15);padding:4px}",
      ...
      // 拉到最大档位的紫色粒子爆炸：从 thumb 中心向外炸开散开，淡出收缩
      ".wd-reason-burst{position:absolute;top:16px;margin-left:-2px;width:4px;height:4px;pointer-events:none;z-index:5}",
      ".wd-reason-particle{position:absolute;left:0;top:0;border-radius:50%;opacity:0;transform:translate(0,0) scale(1);animation-name:wd-particle-burst;animation-timing-function:cubic-bezier(.1,.7,.4,1);animation-fill-mode:forwards}",
      "@keyframes wd-particle-burst{0%{opacity:1;transform:translate(0,0) scale(1)}70%{opacity:.9}100%{opacity:0;transform:translate(var(--dx),var(--dy)) scale(.15)}}",
      ...
      const sliderEl = (() => {
        ...
        return React.createElement("div", {
          ...
          React.createElement("div", { className: "wd-reason-range" },
            ...
            // 拉到最大档位：紫色粒子爆炸（burst 变化 → key 重建 → 动画重播）
              ...
              Array.from({ length: 22 }, (_, i) => {
                ...
                return React.createElement("span", {
                  ...
                  style: {
                    ...
                    animationDuration: (0.55 + Math.random() * 0.4).toFixed(2) + "s"
                  }
                });
              })
            ) : null
