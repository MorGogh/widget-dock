window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    const css = [
      ...
      ".wd-workbench-card:hover{border-color:var(--dsw-alias-state-business-primary);box-shadow:0 6px 22px rgba(0,0,0,.1),0 0 12px rgba(57,100,254,.18)}",
      ...
      // 当前档位大数字：蓝紫渐变 + 微光
      ".wd-reason-glow{background:linear-gradient(120deg,var(--dsw-alias-state-business-primary),#7c4dff);-webkit-background-clip:text;background-clip:text;color:transparent;text-shadow:0 0 18px rgba(57,100,254,.35)}",
      ...
      ".wd-reason-model-btn:hover,.wd-reason-model-btn.open{border-color:var(--dsw-alias-state-business-primary);box-shadow:0 0 10px rgba(57,100,254,.25)}",
      ".wd-reason-model-btn:disabled{opacity:.5;cursor:default}",
      ".wd-reason-caret{font-size:8px;color:var(--dsw-alias-label-tertiary)}",
      ".wd-reason-menu{position:absolute;left:0;right:0;top:28px;z-index:20;max-height:180px;overflow-y:auto;border:1px solid var(--dsw-alias-border-l1);border-radius:8px;background:var(--dsw-alias-bg-base);box-shadow:0 8px 24px rgba(0,0,0,.16);padding:4px}",
      ...
      ".wd-reason-option:hover{background:var(--dsw-alias-interactive-bg-hover)}",
      ".wd-reason-option.selected{color:var(--dsw-alias-state-business-primary);font-weight:600}",
      ".wd-reason-option:disabled{opacity:.5;cursor:default}",
      ".wd-reason-check{font-size:10px;flex:none}",
      // 滑轨（参考官方 slider 视觉：圆角轨道 + 蓝色渐变填充 + tick + 白色圆点 + 光效）
      ".wd-reason-track{position:relative;height:32px;margin-top:6px;touch-action:none;cursor:pointer;outline:none}",
      ".wd-reason-track:focus-visible .wd-reason-thumb{box-shadow:0 0 0 3px rgba(57,100,254,.35),0 0 14px rgba(57,100,254,.5)}",
      ...
      // 蓝色渐变填充：拖动时流光脉动
      ".wd-reason-fill{position:absolute;left:-12px;top:4px;height:24px;border-radius:12px;background:linear-gradient(90deg,#3964fe,#6d8bff);box-shadow:0 0 12px rgba(57,100,254,.45);transition:box-shadow .2s ease}",
      ".wd-reason-track.dragging .wd-reason-fill{box-shadow:0 0 20px rgba(57,100,254,.75);animation:wd-reason-pulse .9s ease infinite}",
      "@keyframes wd-reason-pulse{0%,100%{filter:brightness(1)}50%{filter:brightness(1.25)}}",
      ...
      ".wd-reason-tick.on{background:var(--dsw-alias-state-business-primary);box-shadow:0 0 6px rgba(57,100,254,.8)}",
      ".wd-reason-thumb{position:absolute;top:2.5px;width:27px;height:27px;margin-left:-13.5px;border-radius:50%;background:#fff;box-shadow:0 1px 4px rgba(0,0,0,.25),0 0 10px rgba(57,100,254,.4);box-sizing:border-box;transition:left .16s cubic-bezier(.2,.8,.3,1),box-shadow .2s ease,transform .15s ease}",
      ".wd-reason-track.dragging .wd-reason-thumb{box-shadow:0 2px 8px rgba(0,0,0,.3),0 0 22px rgba(57,100,254,.85);transform:scale(1.1)}",
    ...
    function GithubWidget({ api, config, onConfig, width }) {
      ...
      return React.createElement("div", null,
        React.createElement("div", { className: "wd-balance-amount" },
          React.createElement("span", { className: "wd-balance-val", style: { fontSize: 20 } }, info ? "⭐" : "🐙"),
    ...
    function ReasoningWidget({ api, width }) {
      ...
      useEffect(() => {
        ...
        const closeOutside = (event) => {
          if (!event.target || !event.target.closest || !event.target.closest(".wd-reason-root")) setModelOpen(false);
        };
      ...
      // 模型选择框内容（分组菜单）
      const modelMenu = modelOpen ? React.createElement("div", { className: "wd-reason-menu" },
      ...
      return React.createElement("div", { className: "wd-reason-root" },
        ...
        React.createElement("div", { className: "wd-reason-model", style: { marginTop: 6 } },
          React.createElement("button", {
            className: "wd-reason-model-btn" + (modelOpen ? " open" : ""),
