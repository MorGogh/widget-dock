window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    const css = [
      ...
      ".wd-workbench{position:fixed;right:18px;top:92px;width:268px;max-height:calc(100vh - 112px);overflow-y:auto;z-index:9000;border:1px solid var(--dsw-alias-border-l1);border-radius:14px;background:var(--dsw-alias-bg-base);box-shadow:0 14px 42px rgba(0,0,0,.2);color:var(--dsw-alias-label-primary)}",
    ...
    function WidgetDock({ useProjection, sessionId, remote }) {
      ...
      return React.createElement(React.Fragment, null,
        !open ? React.createElement("aside", { className: "wd-status", "aria-label": "工作状态" },
          ...
          React.createElement("button", { className: "wd-status-open", onClick: () => setOpen(true) }, "打开工作台")
          ...
          React.createElement("div", { className: "wd-workbench-head" },
            ...
            React.createElement("div", { className: "wd-workbench-actions" },
              ...
              React.createElement("button", { className: "wd-btn", title: "收起工作台", onClick: () => { setPickerOpen(false); setOpen(false); } }, "✕")
            )
          ),
          pickerOpen ? React.createElement(WidgetPicker, { selected: items.map((item) => item.id), onToggle: toggle }) : React.createElement(React.Fragment, null,
            ...
            items.length ? items.map((item, index) => React.createElement(WorkbenchCard, { key: item.id, item: item, index: index, api: api, onRemove: remove, onConfig: updateConfig })) : React.createElement("div", { className: "wd-empty-workbench" }, "还没有固定的信息。\n点击右上角的定制按钮选择项目。")
          )
        )
      );
    }
